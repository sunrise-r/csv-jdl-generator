...
<#if jdlConfig.microservice!=null>
    microservice <#list entity.fields as field> ${field.fieldName} ${field.fieldType} ${field.validation!''} </#list> with ${jdlConfig.microservice}
</#if>